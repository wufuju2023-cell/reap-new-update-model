...
theorem ExistsUnique.intro₂ {p : α → Sort*} [∀ x, Subsingleton (p x)]
  ...
  mathlibSFTReplay "/evidence/final/intro/plan.json" "/evidence/final/intro/replay-trace.json" "/evidence/final/intro/capture-trace.json"
end MathlibSFTGate
#mathlibSFTNoSelf ExistsUnique.intro₂ MathlibSFTGate.ExistsUnique.intro₂
example : @ExistsUnique.intro₂ = @MathlibSFTGate.ExistsUnique.intro₂ := by rfl
#print axioms MathlibSFTGate.ExistsUnique.intro₂
