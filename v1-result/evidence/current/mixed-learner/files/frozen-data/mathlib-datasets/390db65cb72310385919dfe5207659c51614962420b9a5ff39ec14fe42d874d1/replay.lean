...
theorem ExistsUnique.unique₂ {p : α → Sort*} [∀ x, Subsingleton (p x)]
  ...
  mathlibSFTReplay "/evidence/final/unique/plan.json" "/evidence/final/unique/replay-trace.json" "/evidence/final/unique/capture-trace.json"
end MathlibSFTGate
#mathlibSFTNoSelf ExistsUnique.unique₂ MathlibSFTGate.ExistsUnique.unique₂
example : @ExistsUnique.unique₂ = @MathlibSFTGate.ExistsUnique.unique₂ := by rfl
#print axioms MathlibSFTGate.ExistsUnique.unique₂
