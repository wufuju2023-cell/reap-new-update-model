...
run_cmd do
  ...
  let name : Lean.Name := Lean.Name.str (Lean.Name.str (Lean.Name.anonymous) "ClosedFixture") "trueClaim"
...
theorem ReapCurriculumWrapper.attempt : _root_.ClosedFixture.trueClaim := by
  unfold _root_.ClosedFixture.trueClaim
  reapVerifiedReplay "/campaign/verified/mm-36267162d92ac4de7d4e-00002/dataset/plan.json" "/campaign/verified/mm-36267162d92ac4de7d4e-00002/dataset/trace.json"

open Lean in
run_cmd do
  let target : Lean.Name := Lean.Name.str (Lean.Name.str (Lean.Name.anonymous) "ClosedFixture") "trueClaim"
