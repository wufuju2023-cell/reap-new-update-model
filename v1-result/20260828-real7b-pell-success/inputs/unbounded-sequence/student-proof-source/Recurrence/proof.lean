...
run_cmd do
  ...
  let name : Lean.Name := Lean.Name.str (Lean.Name.str (Lean.Name.str (Lean.Name.anonymous) "CodexMathFive") "Pell") "CourseRecurrence"
...
theorem ReapCurriculumWrapper.attempt : _root_.CodexMathFive.Pell.CourseRecurrence := by
  unfold _root_.CodexMathFive.Pell.CourseRecurrence
  intro s h₀ h₁ k
...
open Lean in
run_cmd do
  let target : Lean.Name := Lean.Name.str (Lean.Name.str (Lean.Name.str (Lean.Name.anonymous) "CodexMathFive") "Pell") "CourseRecurrence"
