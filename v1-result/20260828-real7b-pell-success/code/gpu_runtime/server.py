...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--backend", choices=("toy", "real", "real-search", "verified-replay", "mixed-replay"), default="real")
...
def build_backend(args: argparse.Namespace):
    ...
    if getattr(args, 'success_dataset_root', None) is not None and args.backend != 'real-search':
        raise ValueError('--success-dataset-root requires real-search')
    ...
    if args.max_post_update_kl is not None and args.backend not in {"real-search", "verified-replay", "mixed-replay"}:
