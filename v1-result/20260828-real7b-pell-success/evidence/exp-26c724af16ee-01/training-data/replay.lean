...
run_cmd do
  ...
  let name : Lean.Name := Lean.Name.str (Lean.Name.str (Lean.Name.str (Lean.Name.anonymous) "CodexMathFive") "Pell") "CourseUnboundedFromRecurrence"
...
run_cmd Lean.Elab.Command.liftTermElabM do
  let target : Lean.Name := Lean.Name.str (Lean.Name.str (Lean.Name.str (Lean.Name.anonymous) "CodexMathFive") "Pell") "CourseUnboundedFromRecurrence"
  let closed ← Lean.Meta.deltaExpand (Lean.mkConst target) (· == target)
  let negative := Lean.mkApp (Lean.mkConst ``Not) closed
  let hints : Array (Lean.Name × Lean.Name × String) := #[(Lean.Name.str (Lean.Name.str (Lean.Name.str (Lean.Name.anonymous) "CodexMathFive") "Pell") "StudentLibraryRecurrence", Lean.Name.str (Lean.Name.str (Lean.Name.str (Lean.Name.anonymous) "CodexMathFive") "Pell") "CourseRecurrence", "b02864630325fb50b95a715cb04925a633924cbda1e063e1ea5bc3408f7ea22c"), (Lean.Name.str (Lean.Name.str (Lean.Name.str (Lean.Name.anonymous) "CodexMathFive") "Pell") "StudentLibraryIndexedWitness", Lean.Name.str (Lean.Name.str (Lean.Name.str (Lean.Name.anonymous) "CodexMathFive") "Pell") "CourseIndexedWitness", "b8dac2d50ea6c2b5ac59a9685ee8b485307a24443e2ebbe01e1827225abe8d10")]
...
def ReapCurriculumWrapper.studentProofSelector : Lean.LibrarySuggestions.Selector := fun _ config => do
  let names : Array Lean.Name := #[(Lean.Name.str (Lean.Name.str (Lean.Name.str (Lean.Name.anonymous) "CodexMathFive") "Pell") "StudentLibraryRecurrence"), (Lean.Name.str (Lean.Name.str (Lean.Name.str (Lean.Name.anonymous) "CodexMathFive") "Pell") "StudentLibraryIndexedWitness")]
...
theorem ReapCurriculumWrapper.attempt : _root_.CodexMathFive.Pell.CourseUnboundedFromRecurrence := by
  unfold _root_.CodexMathFive.Pell.CourseUnboundedFromRecurrence
  ...
  reapVerifiedReplay "${HISTORICAL_RUNS}/radeon-pell-unbounded-after-indexed-cpu15-20260828-native/replay-01/plan.json" "${HISTORICAL_RUNS}/radeon-pell-unbounded-after-indexed-cpu15-20260828-native/replay-01/trace.json"
