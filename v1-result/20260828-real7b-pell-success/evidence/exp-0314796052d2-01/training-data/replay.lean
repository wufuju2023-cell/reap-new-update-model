...
theorem ReapCurriculumWrapper.attempt : _root_.CodexMathFive.Pell.CourseExplicitSuccessor := by
  ...
  reapVerifiedReplay "${HISTORICAL_RUNS}/radeon-pell-composition-explore-code11-20260828-native/replay-000/plan.json" "${HISTORICAL_RUNS}/radeon-pell-composition-explore-code11-20260828-native/replay-000/trace.json"
