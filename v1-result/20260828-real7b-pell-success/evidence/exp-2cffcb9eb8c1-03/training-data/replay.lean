...
run_cmd do
  ...
  let name : Lean.Name := Lean.Name.str (Lean.Name.str (Lean.Name.str (Lean.Name.anonymous) "CodexMathFive") "Pell") "CourseSequenceExists"
...
theorem ReapCurriculumWrapper.attempt : _root_.CodexMathFive.Pell.CourseSequenceExists := by
  unfold _root_.CodexMathFive.Pell.CourseSequenceExists
  reapVerifiedReplay "${HISTORICAL_RUNS}/radeon-pell-success-code04-20260828-native/pell-replay-002/plan.json" "${HISTORICAL_RUNS}/radeon-pell-success-code04-20260828-native/pell-replay-002/trace.json"

open Lean in
run_cmd do
  let target : Lean.Name := Lean.Name.str (Lean.Name.str (Lean.Name.str (Lean.Name.anonymous) "CodexMathFive") "Pell") "CourseSequenceExists"
