...
theorem ReapCurriculumWrapper.attempt : _root_.CodexMathFive.Pell.CourseIndexedWitness := by
  ...
  reapVerifiedReplay "${HISTORICAL_RUNS}/radeon-pell-indexed-witness-cpu15-20260828-native/replay-01/plan.json" "${HISTORICAL_RUNS}/radeon-pell-indexed-witness-cpu15-20260828-native/replay-01/trace.json"
